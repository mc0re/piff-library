...
{
    [BoxName("mvhd")]
    public sealed class PiffMovieHeaderBox : PiffFullBoxBase
    {
        #region Properties
        ...
        /// </summary>
        public PiffMovieHeaderBox(DateTime created, ulong duration, uint timeScale)
        {
            Version = 1;
