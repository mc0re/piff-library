...
namespace PiffLibrary.Boxes
{
    ...
    /// </summary>
    [BoxName("tkhd")]
    public sealed class PiffTrackHeaderBox : PiffFullBoxBase
    {
        #region Properties
        ...
        /// <summary>
        /// Track duration in <see cref="PiffMovieHeaderBox.TimeScale"/>.
        /// </summary>
        [PiffDataFormat(nameof(GetDateFormat))]
        ...
        /// Constructor for writing.
        /// </summary>
        public static PiffTrackHeaderBox CreateAudio(uint trackId, DateTime created, ulong duration)
        {
            return new PiffTrackHeaderBox(created, duration, trackId, PiffTrackTypes.Audio, 0, 0);
        }
        ...
        /// Constructor for writing.
        /// </summary>
        public static PiffTrackHeaderBox CreateVideo(uint trackId, DateTime created, PiffVideoManifest video)
        {
            return new PiffTrackHeaderBox(created, video.Duration, trackId, PiffTrackTypes.Video,
